    ...
    public function store(Request $request): JsonResponse
    {
        try {
            $validated = $request->validate([
                ...
                'employment_type' => 'required|in:full-time,part-time,contract,fixed-term,trainee',
    ...
    public function update(Request $request, $id): JsonResponse
    {
        try {
            ...
            $validated = $request->validate([
                ...
                'employment_type' => 'sometimes|in:full-time,part-time,contract,fixed-term,trainee',
